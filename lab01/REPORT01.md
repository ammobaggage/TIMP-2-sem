...
Комманда: 
```
tar -xf boost_1_69_0.tar.gz -C ~/boost_1_69_0
```
...
Комманда: 
```
grep -r "boost::asio" ~/boost_1_69_0 > result.txt
```
Вывод: [тут](https://gist.github.com/ammobaggage/9227f5a58b87140c73d85cd6a886c9d1)
...
```
Вывод:[тут](https://gist.github.com/ammobaggage/299f49d43eb96ededed1df143d93b187)
